...
static  double fbSpeedRatio;
static 	double lrSpeedRatio;
static double preMouseY[2];
/**
...
/**
*Receive signals generated by remote controller
*/
void RC_Receive(void){
				...
				preMouseY[0]=preMouseY[1];
				preMouseY[1]=RC_Ctl.mouse.y;
				...
				if(sbus_rx_buffer[13]==1&&RC_Ctl.mouse.press_r==0)
				{
					RC_Ctl.mouse.isUpedge_r=1;
					RC_Ctl.mouse.isDownedge_r=0;
				}
				else if(sbus_rx_buffer[13]==1&&RC_Ctl.mouse.press_r==1)
				{
					RC_Ctl.mouse.isUpedge_r=1;
					RC_Ctl.mouse.isDownedge_r=0;
				}else if(sbus_rx_buffer[13]==0&&RC_Ctl.mouse.press_r==1)
				{
					RC_Ctl.mouse.isUpedge_r=1;
...
/**=====================================Shooting part==================================**/
	if(RC_Ctl.mouse.isClicked_r==1&&RC_Ctl.velocity.isBMSet==0&&RC_Ctl.velocity.isStepperMoving==0)
		{
			if(RC_Ctl.velocity.BMPWM<0.1*BM_PWM_MAX)RC_Ctl.velocity.BMPWM=BM_PWM_MAX*0.1;
			else RC_Ctl.velocity.BMPWM=BM_PWM_MAX*0.05;
			RC_Ctl.velocity.isBMSet=1;
		}
	else if(RC_Ctl.mouse.isClicked_r==0)
	{
		RC_Ctl.velocity.isBMSet=0;
	}
